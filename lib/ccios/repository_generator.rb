...
class RepositoryGenerator
  ...
  def generate(repository_name, options = {})
    ...
    core_data_new_group = core_group.new_group(repository_name, core_data_new_group_path)
    ...
    data_new_group = data_group.new_group(repository_name, data_new_group_path)
